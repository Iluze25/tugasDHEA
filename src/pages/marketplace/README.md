...
Proyek ini dibuat untuk tujuan pembelajaran dan pengembangan frontend. Seluruh data yang digunakan merupakan data simulasi (dummy data) dan tidak mewakili data nyata.
